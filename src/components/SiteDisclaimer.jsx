    ...
    <div className="bg-primary dark:bg-accent/20 border-b border-primary/30 dark:border-accent/30 px-4 py-2.5 relative" style={{ paddingTop: 'max(0.625rem, env(safe-area-inset-top, 0px))' }}>
      <div className="max-w-7xl mx-auto flex items-start gap-3 pr-8">
        ...
        <p className="text-xs text-primary-foreground dark:text-accent/90 leading-relaxed flex-1">
          <strong>AI-Powered Analysis — Not Investment Advice:</strong> This platform was built to combat the widespread fraud and misinformation in commodity investing. All reports, calculations, and analyses on this site are AI-driven and for educational purposes only. Commodity Investor+, LLC is not a registered broker-dealer, investment adviser, CPA firm, law firm, or FINRA member. Nothing here constitutes investment, tax, or legal advice. All outputs are hypothetical and illustrative. Commodity investments are speculative and involve substantial risk, including total loss of capital.{" "}
