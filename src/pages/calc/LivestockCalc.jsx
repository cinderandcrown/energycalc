    ...
    <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-card p-5 space-y-5">
        <div className="flex items-center gap-2 pb-3 border-b border-border">
          <Beef className="w-4 h-4 text-crude-gold" aria-hidden="true" />
      ...
      <div className="rounded-2xl border border-border bg-card p-5 space-y-5">
        <div className="flex items-center gap-2 pb-3 border-b border-border">
          <TrendingUp className="w-4 h-4 text-drill-green" aria-hidden="true" />
        ...
        <div className="rounded-xl border border-border bg-muted/20 p-3">
          <h3 className="text-xs font-semibold text-foreground mb-2">Cost Breakdown</h3>
          ...
          <table className="sr-only" aria-label="Chart data: Cost Breakdown">
            ...
            <tbody>
              {results.costBreakdown.map((row, i) => (
                <tr key={i}>
                  <td>{row.name}</td>
                  <td>${row.value.toLocaleString("en-US", { maximumFractionDigits: 0 })}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <div className="rounded-xl border border-border bg-muted/20 p-4 space-y-2">
          <h3 className="text-xs font-semibold text-foreground mb-2">Per-Head Economics</h3>
          {[
