        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
          ...
          <div className="p-4 rounded-xl border border-border bg-muted/30 space-y-2">
            <p className="text-[10px] text-muted-foreground leading-relaxed">
              <strong className="text-foreground">⚠️ AI-Generated Content — May Contain Errors:</strong> This screening report was generated by artificial intelligence and <strong className="text-foreground">may contain hallucinations, fabricated information, inaccuracies, or outdated data</strong>. The AI does not access proprietary databases, court records, or state regulatory systems in real time. Names, dates, enforcement actions, and company details in this report may be incorrect or entirely fabricated by the AI model.
            </p>
            <p className="text-[10px] text-muted-foreground leading-relaxed">
              <strong className="text-foreground">Not a Background Check:</strong> This is NOT a legal background check, securities analysis, due diligence report, or investment advice. The Trust Score is an AI-generated estimate — not a certified, verified, or auditable rating. Do NOT rely on this report to make investment decisions.
            </p>
            <p className="text-[10px] text-muted-foreground leading-relaxed">
              <strong className="text-foreground">You Must Verify Independently:</strong> Always verify ALL information through official sources: SEC EDGAR, FINRA BrokerCheck, state courts, and the relevant state oil & gas regulatory board. Consult a licensed securities attorney before investing in any offering.
            </p>
          </div>
        </motion.div>
      )}
